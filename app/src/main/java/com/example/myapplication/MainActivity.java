...
public class MainActivity extends AppCompatActivity {
    Button emiCalcBtn; //init button
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main); //set home page
//all variables needed for EMI
        final EditText P = (EditText) findViewById(R.id.principal_amount);
        final EditText I = (EditText) findViewById(R.id.interest_rate);
        final EditText Y = (EditText) findViewById(R.id.tenure_length);
        final EditText result = (EditText) findViewById(R.id.emi);
        emiCalcBtn = (Button) findViewById(R.id.calculate_button);
    ...
    //formulas for actually calculating the emi
